...
## Project Structure
    ...
    ├── dsgfasgeragsea_dev_69088  # Django project configurations
...
1. Clone this repo and `cd dsgfasgeragsea_dev_69088`
...
2. Clone this repo and `cd dsgfasgeragsea_dev_69088`
